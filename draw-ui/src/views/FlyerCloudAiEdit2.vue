        ...
        <div ref="bodyRef" style="position: relative;padding: 0;z-index: 999;width:100%;height: 100%;display: flex;justify-content: center;align-items: center;flex-direction: column">
          <div style="position: relative;padding: 0;background: rgba(204,198,198,0.47);" :style="{width:toolData.svgWidth + 'px', height:toolData.svgHeight + 'px'}">
            <svg ref="svgRef" :style="{width:'100%', height:'100%'}">
              ...
              <g id="root" ref="svgEl">
                <g transform="100,200">
                  <circle r="30" cx="60" cy="60" fill="red" stroke="blue" stroke-width="2"></circle>
                  <circle r="30" cx="160" cy="60" fill="red" stroke="blue" stroke-width="2"></circle>
                  <circle r="30" cx="260" cy="60" fill="red" stroke="blue" stroke-width="2"></circle>
                  <rect x="120" y="380" width="80" height="80" fill="yellow" stroke="green" stroke-width="2" ></rect>
                  <rect x="520" y="380" width="80" height="80" fill="yellow" stroke="green" stroke-width="2" ></rect>
                  <rect x="620" y="280" width="80" height="80" fill="yellow" stroke="green" stroke-width="2" ></rect>
                </g>
